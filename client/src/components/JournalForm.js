...
setRecommendations(data.recommendations || []);
  ...
  return (
    ...
    {analysis && (
  <div style={{ marginTop: 20, padding: 16, backgroundColor: "#e6f0f8", borderRadius: 8 }}>
    {/* <h4>How your entry made us feel</h4> */}
    <p style={{ marginTop: 10, fontStyle: "italic" }}>{analysis.calmingMessage}</p>
...
{recommendations.length > 0 && (
  <div style={{ marginTop: 20, padding: 16, backgroundColor: "#f0f4f8", borderRadius: 8 }}>
    <h4>Recommended Resources</h4>
    <ul>
      {recommendations.map((rec, idx) => (
        <li key={idx} style={{ marginBottom: 8 }}>
          <a href={rec.url} target="_blank" rel="noopener noreferrer" style={{ fontWeight: "bold", color: "#0056b3" }}>
            {rec.title}
          </a>
